export default {
  ...
  customLodSingleMapTip: 'This feature only supports a single map.',
  wrongScaleRangeWarning: 'The selected scale range exceeds the map definition. The zoom function will be limited.',
  customizeScaleList: 'Customize scales list',
  adjustScaleRange: 'Adjust scale range',
  originalScaleRangeTip: "Reference: Map's original scale range",
  hoverMapName: 'Map: {mapName}',
  lodSingleMapTip: 'This feature only supports a single web map.',
  resetLod: 'Reset to the map’s initial scales',
  typeScale: 'Type a scale value',
  keepAtLeastOneLod: 'The last scale can not be deleted.',
  autoScalebarOptionsTip: 'Style defaults to Line. Units follow profile settings when signed in; otherwise, organization settings or both metric and imperial.',
  metric: 'Metric',
  imperial: 'Imperial',
  dual: 'Dual',
  decimalPlaceCount: 'Number of decimal places',
  scaleBarLine: 'Line',
  scaleBarRuler: 'Ruler',
  scaleBarNumber: 'Number',
